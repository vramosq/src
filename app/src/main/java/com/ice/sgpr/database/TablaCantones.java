...
public class TablaCantones implements IDatabaseTable{
	...
	public void onCreate(SQLiteDatabase pDatabase) {
		...
		try 
		{
			InputStream is = SgprApplication.getContext().getAssets().open("data/cantones.txt");
	...
	public void onUpgrade(SQLiteDatabase pDatabase, int pOldVersion,
		...
		//Table Name
		public static final String NOMBRE_TABLA = "CANTONES";
		
		//Columns of the table
		public static final String COL_CODIGO_CANTON = "CANTON_ID";
		public static final String COL_CODIGO_PROVINCIA = "PROVINCIA_ID";
		public static final String COL_NOMBRE_CANTON = "NOMBRE";

		//Creation of the table 
		private static final String SQL_CREATE_TABLE = "CREATE TABLE " + NOMBRE_TABLA + "( "
														+ COL_CODIGO_CANTON + " INTEGER NOT NULL, "
														+ COL_CODIGO_PROVINCIA + " INTEGER NOT NULL,"
														+ COL_NOMBRE_CANTON + " TEXT NOT NULL"
														+ ");";
		...
		private static final String SQL_INSERT = "INSERT INTO " + NOMBRE_TABLA  + " ( " 
				+ COL_CODIGO_CANTON + " , "
				+ COL_CODIGO_PROVINCIA + " , "
				+ COL_NOMBRE_CANTON + " ) VALUES (?,?,?)";
}	